  ...
  settings: {
    ...
    host: {
      ...
      agents: {
        ...
        keepIdleAgentsAlive: {
          title: "Держать простаивающие агенты активными",
          hint: "Предотвращает закрытие Paseo агентов, которые простаивают, так что процесс агента остаётся запущен между сессиями.",
          accessibilityLabel: "Держать простаивающие агенты активными",
        },
        idleAgentTimeout: {
          title: "Тайм-аут простоя",
          hint: "Минуты до автоматического закрытия простаивающего агента. По умолчанию: 2.",
          accessibilityLabel: "Тайм-аут простоя в минутах",
          error: "Введите целое число от 1 до 60.",
        },
        maxIdleAgents: {
          title: "Макс. простаивающих агентов",
          hint: 'Предел безопасности. Если "Держать простаивающие агенты активными" включён, самые старые простаивающие агенты выше этого лимита удаляются. По умолчанию: 20.',
          accessibilityLabel: "Максимум простаивающих агентов",
          error: "Введите целое число от 0 до 1000.",
        },
        closeIdleAgents: {
          title: "Закрыть простаивающие агенты",
          hint: "{{count}} простаивающих агентов в каталоге. Закрывает их процессы; история сохраняется.",
          cta: "Закрыть {{count}}",
          confirmMessage:
            "Это закроет {{count}} простаивающих агентов и остановит их процессы. Любой закрытый агент можно возобновить из истории.",
          confirmCta: "Закрыть {{count}} агент(ов)",
          errorTitle: "Не удалось закрыть простаивающие агенты",
          accessibilityLabel: "Закрыть простаивающие агенты",
          resultTitle: "Закрыто агентов: {{closed}} ({{failed}} с ошибкой)",
          resultMessage:
            "Закрыто {{closed}} из {{total}} простаивающих агентов в каталоге; {{failed}} с ошибкой. Некоторые могут быть защищены расписаниями или иметь ожидающие разрешения.",
          resultNoneTitle: "Закрыть было нечего",
          resultNoneMessage:
            "Paseo не закрыл ни одного из {{total}} простаивающих агентов в каталоге. Это могут быть внутренние системные агенты, защищённые расписаниями или с ожидающими разрешениями.",
        },
      },
      workspaces: {
